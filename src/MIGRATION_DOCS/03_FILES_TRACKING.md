...
### User & Access Control Controllers (3 files)
- [x] Admin/User/PermissionController.php
...
### Destination Controller (2 files)
...
### Enum Classes (8 files)
- [x] Enums/ActivityType.php
- [x] Enums/QuoteStatusEnums.php
- [x] Enums/DocumentType.php
- [x] Enums/SellerChannel.php
- [x] Enums/Seniority.php
- [x] Enums/TextGenerationModel.php
- [x] Enums/TicketChannel.php
- [x] Enums/TicketSubject.php

### DataTable Classes (26 files)
...
- [x] DataTables/Website/WebsitesDataTable.php
...
- [x] DataTables/Itinerary/ItinerariesDataTable.php
- [x] DataTables/Itinerary/ItineraryElementsDataTable.php
...
- [x] Actions/Provider/Cruiseline/IndexFibosCruiseline.php
- [x] Actions/Product/DestroyProduct.php
- [x] Actions/Product/IndexProduct.php
- [x] Actions/Product/SaveProduct.php
- [x] Actions/Port/DestroyPort.php
- [x] Actions/Port/EditPort.php
